...
namespace Physics
{
  ...
  */
  ...
  public:
    ...
    bool PropagateFreeToSphere(const Vec3D& center, double radius, 
  ...
  */
  ...
  {
    InitializePDGData();
    return s_pdgdata_name_q[std::make_pair<std::string, int>(name,charge)];
  }
  ...
  { 
    return Constants::cgs_hbar/width; 
  }
