...
static double hex_nghbr(double , double , hex []);
static void xy_to_hex(double *, double *, hex *);
static void hex_to_xy(hex , double *, double *);
static void hex_to_nh(hex , int *);
static void nh_to_hex(int , hex *);

/* DEFINE STATEMENTS */
#define s 1.73205080756887729352744634150587  /* sqrt(3.) */

void xy_to_nh(double *x, double *y, int *nh)
/*
...
void nh_to_xy(int *nh, double *x, double *y)
/*
