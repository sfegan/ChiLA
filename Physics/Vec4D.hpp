...
#ifndef PHYSICS_VEC4D_H
#define PHYSICS_VEC4D_H
...
namespace std
{
  inline ostream& operator << (ostream& stream, const Physics::Vec4D& v);
  inline istream& operator >> (istream& stream, Physics::Vec4D& v);
